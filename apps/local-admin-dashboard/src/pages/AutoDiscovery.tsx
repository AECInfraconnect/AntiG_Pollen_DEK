    ...
    <div className="p-6 md:p-8 space-y-6">
      ...
      {protectTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="fixed inset-0 bg-background/80 backdrop-blur-sm transition-opacity" onClick={() => setProtectTarget(null)} />
          <div className="relative z-50 w-full max-w-3xl rounded-xl border bg-card p-6 shadow-lg max-h-[90vh] overflow-y-auto">
            ...
            <SimplePolicyWizard 
              agents={candidates.map(c => ({ id: c.candidate_id, label: c.display_name }))}
