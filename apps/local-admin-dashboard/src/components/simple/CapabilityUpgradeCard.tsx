...
export function CapabilityUpgradeCard({ upgrade }: { upgrade: CapabilityUpgrade }) {
  ...
  return (
    <div className="rounded-xl border border-zinc-700 bg-zinc-800/40 p-4">
      <div className="text-sm font-medium text-zinc-200">🔧 {upgrade.unlocks}</div>
      ...
      <div className="mt-3 flex gap-2">
        ...
        {upgrade.download_url && (
          <a href={upgrade.download_url} target="_blank" rel="noreferrer"
