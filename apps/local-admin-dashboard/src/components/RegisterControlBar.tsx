...
export const RegisterControlBar: React.FC<RegisterControlBarProps> = ({ agentId, tenantId, onSuccess }) => {
  ...
  const handleRegister = async () => {
    ...
    setResult(null);
    try {
      const resp = await fetch(`/api/v1/tenants/${tenantId}/agents/${agentId}/register`, {
        method: 'POST',
        headers: {
