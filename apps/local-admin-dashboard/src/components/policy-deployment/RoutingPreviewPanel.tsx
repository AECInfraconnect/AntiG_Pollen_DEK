    ...
    <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      ...
      {plan.fallback_pep && (
        <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md border border-yellow-200 dark:border-yellow-700">
          <h4 className="text-sm font-semibold text-yellow-800 dark:text-yellow-500 uppercase tracking-wider mb-2">
            Fallback PEP Layer
          </h4>
          <p className="text-md font-medium text-yellow-900 dark:text-yellow-400">
            {plan.fallback_pep.name.en}
          </p>
          <p className="text-sm text-yellow-700 dark:text-yellow-600 mt-1 font-mono">
            {plan.fallback_pep.layer}
          </p>
        </div>
      )}
    </div>
