  ...
  const handleToggleAll = () => {
    ...
    if (allSelected) {
      ...
      if (onProviderSelectionChange)
        onProviderSelectionChange(providers.map((p) => p.provider_id));
    }
  };
          ...
          <>
            <label className="flex items-center gap-2 border-b pb-3 mb-3 cursor-pointer">
              ...
              <span className="font-medium">
                All Compatible Agents & Providers
              </span>
            </label>
              ...
              {providers.map((provider) => (
                ...
                >
                  <input
                    type="checkbox"
                    checked={
                      selectedProviders?.includes(provider.provider_id) || false
                    }
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium">
                      {provider.name}{" "}
                      <span className="ml-2 text-[10px] uppercase tracking-wider bg-purple-500/10 text-purple-600 px-1.5 py-0.5 rounded">
                        Blackbox AI
                      </span>
                    </span>
                    <span className="text-xs text-muted-foreground">
