# Pollen DEK Example Policies

This directory contains simple generic policies for each of the supported Policy Decision Point (PDP) engines in the Pollen DEK ecosystem.
