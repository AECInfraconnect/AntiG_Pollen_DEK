...
#[cfg(target_os = "linux")]
pub mod ffi {
    use libc::{c_int, c_uint, uint64_t};
    ...
    pub const FAN_ACCESS: uint64_t = 0x0000_0001;
    pub const FAN_MODIFY: uint64_t = 0x0000_0002;
    pub const FAN_CLOSE_WRITE: uint64_t = 0x0000_0008;
    pub const FAN_OPEN: uint64_t = 0x0000_0020;
