...
impl EvidencePackager {
    ...
    pub fn generate_markdown_report(&self, redact: bool) -> Result<String> {
        ...
        report.push_str("- **Article 10 (Data and Data Governance)**: Local registry controls MCP access.\n");
        ...
        report.push_str("- **A.2.1 AI Policies**: Handled by DEK's Policy Router and PDP/PEP separation.\n");
        report.push_str("- **A.7.2 Traceability**: Detailed execution history is maintained locally.\n\n");
        ...
        report.push_str("System operates under strict egress controls (Sovereign Mode compatible).\n");
