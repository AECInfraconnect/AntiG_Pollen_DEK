# Local Enforcement Kit Consumer Guide

Local Enforcement Kit acts as the client for Pollek Cloud and the Local Control Plane. It must adhere to the contracts provided here.
